...
@Component
class ApplyModuleSetCommand implements Seed4JCommand, Callable<Integer> {
  ...
  public CommandSpec spec() {
    commandSpec = CommandSpec.wrapWithoutInspection(this).name(name()).mixinStandardHelpOptions(true);
    commandSpec.usageMessage().description("Plan a set of Seed4J modules without applying changes");
    ...
    addModulePropertyOptions(commandSpec);
