...
@Configuration
@Import({ RuntimeExtensionListOnlyModuleConfiguration.class, RuntimeExtensionApplySharedContextModuleConfiguration.class })
public class RuntimeExtensionApplySharedApplication {
